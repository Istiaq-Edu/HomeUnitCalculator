...
class HistoryTab(QWidget):
    ...
    def init_ui(self):
        ...
        load_history_button = PrimaryPushButton("Load History Table")
        ...
        self.edit_selected_record_button = PushButton("Edit Record")
        ...
        self.delete_selected_record_button = PushButton("Delete Record")
